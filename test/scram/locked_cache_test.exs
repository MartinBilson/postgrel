defmodule PostGrex.SCRAM.LockedCacheTest do
  use ExUnit.Case, async: true

  alias Postgrex.SCRAM.LockedCache, as: LC
  ...
  test "locks cache keys", config do
    ...
    assert_receive {^first_ref, :this_is_cached}
    assert_receive {^second_ref, :this_is_cached}
